# 1 "Source/TouchPanel/TouchPanel.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 393 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "Source/TouchPanel/TouchPanel.c" 2
# 24 "Source/TouchPanel/TouchPanel.c"
# 1 "Source/TouchPanel\\../GLCD/GLCD.h" 1
# 26 "Source/TouchPanel\\../GLCD/GLCD.h"
...
# 27 "Source/TouchPanel\\../GLCD/GLCD.h" 2
# 90 "Source/TouchPanel\\../GLCD/GLCD.h"
...
# 25 "Source/TouchPanel/TouchPanel.c" 2
# 1 "Source/TouchPanel\\../TouchPanel/TouchPanel.h" 1
# 30 "Source/TouchPanel\\../TouchPanel/TouchPanel.h"
...
# 76 "Source/TouchPanel\\../TouchPanel/TouchPanel.h"
void TP_Init(void);
...
Coordinate DisplaySample[3] = {{ 45, 45},
                { 45, 270},
                               {190, 190}} ;
# 51 "Source/TouchPanel/TouchPanel.c"
...
# 68 "Source/TouchPanel/TouchPanel.c"
static void ADS7843_SPI_Init(void)
{
 volatile uint32_t dummy;


 ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCONP |= (1 << 10);
...
# 106 "Source/TouchPanel/TouchPanel.c"
void TP_Init(void)
{
  ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIODIR |= (1<<6);
  ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIODIR |= (0<<13);
  if (1) ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET = (1<<6); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR = (1<<6);
  ADS7843_SPI_Init();
}
# 122 "Source/TouchPanel/TouchPanel.c"
...
# 144 "Source/TouchPanel/TouchPanel.c"
static uint8_t WR_CMD (uint8_t cmd)
{
  ...
  while (((LPC_SSP_TypeDef *) ((0x40000000UL) + 0x30000) )->SR & (1 << 4) );
  while( !( ((LPC_SSP_TypeDef *) ((0x40000000UL) + 0x30000) )->SR & ( 1 << 2 ) ) );
  byte_r = ((LPC_SSP_TypeDef *) ((0x40000000UL) + 0x30000) )->DR;

  return byte_r;
}
# 167 "Source/TouchPanel/TouchPanel.c"
...
# 190 "Source/TouchPanel/TouchPanel.c"
int Read_X(void)
{
  int i;
  if (0) ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET = (1<<6); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR = (1<<6);
  DelayUS(1);
  WR_CMD(0x90);
  DelayUS(1);
  i=RD_AD();
...
# 210 "Source/TouchPanel/TouchPanel.c"
int Read_Y(void)
{
  int i;
  if (0) ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET = (1<<6); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR = (1<<6);
...
void DrawCross(uint16_t Xpos,uint16_t Ypos)
{
  ...
  LCD_DrawLine(Xpos-15,Ypos+15,Xpos-7,Ypos+15,(uint16_t)( (( 184 >> 3 ) << 11 ) | (( 158 >> 2 ) << 5 ) | ( 131 >> 3 )));
  LCD_DrawLine(Xpos-15,Ypos+7,Xpos-15,Ypos+15,(uint16_t)( (( 184 >> 3 ) << 11 ) | (( 158 >> 2 ) << 5 ) | ( 131 >> 3 )));
...
void DeleteCross(uint16_t Xpos,uint16_t Ypos)
{
  ...
  LCD_DrawLine(Xpos-15,Ypos+15,Xpos-7,Ypos+15,(uint16_t)( (( 0 >> 3 ) << 11 ) | (( 0 >> 2 ) << 5 ) | ( 0 >> 3 )));
  LCD_DrawLine(Xpos-15,Ypos+7,Xpos-15,Ypos+15,(uint16_t)( (( 0 >> 3 ) << 11 ) | (( 0 >> 2 ) << 5 ) | ( 0 >> 3 )));
...
void TouchPanel_Calibrate(void)
{
 ...
 LCD_Clear(0x0000);
  GUI_Text(10,10, (unsigned char*) "Touch crosshair to calibrate",0xffff,0x0000);
